<title>Book Store | Age 2 - 4 Years</title>
...
<center><h1 style="font-family: 'Courgette', cursive;">Age 2 - 4 Years</h1></center>

<div class="main">

<?php

		$sql = "SELECT * FROM books WHERE AGE LIKE '%2 - 4%' ORDER BY id ASC";

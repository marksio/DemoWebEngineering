<title>Book Store | Young Adult</title>
...
<center><h1 style="font-family: 'Courgette', cursive;">Young Adult</h1></center>

<div class="main">

<?php

		$sql = "SELECT * FROM books WHERE AGE LIKE '%12++%' ORDER BY id ASC ";

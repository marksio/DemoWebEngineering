<title>Book Store | Staff Picks</title>
...
<center><h1 style="font-family: 'Courgette', cursive;">Staff Picks</h1></center>

<div class="main">

<?php

		$sql = "SELECT * FROM books WHERE SPECIAL LIKE '%staffpick%' ORDER BY id ASC";

<title>Book Store | Best Sellers</title>
<?php
	include_once('header.php');
?>
<link href="css/special.css" type="text/css" rel="stylesheet"/>
<center><h1 style="font-family: 'Courgette', cursive;">Best Sellers</h1></center>
<div class="main">
<?php
		$sql = "SELECT * FROM BOOKS WHERE SPECIAL LIKE '%best%' ORDER BY id ASC";

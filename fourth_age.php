<title>Book Store | Age 6 - 8 Years</title>
...
<center><h1 style="font-family: 'Courgette', cursive;">Age 6 - 8 Years</h1></center>

<div class="main">

<?php

		$sql = "SELECT * FROM books WHERE AGE LIKE '%6 - 8%' ORDER BY id ASC ";

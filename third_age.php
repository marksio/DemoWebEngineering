<title>Book Store | Age 4 - 6 Years</title>
...
<center><h1 style="font-family: 'Courgette', cursive;">Age 4 - 6 Years</h1></center>

<div class="main">

<?php

		$sql = "SELECT * FROM books WHERE AGE LIKE '%4 - 6%' ORDER BY id ASC";
